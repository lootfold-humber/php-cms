...
if (isset($_FILES['photo'])) {
    ...
    set_message('User photo has been updated');
...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['delete'])) {
      ...
      LIMIT 1';
        ...
        set_message('User photo has been deleted');
...
<?php if ($record['photo']) : ?>
    ...
    <p><a href="users_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
